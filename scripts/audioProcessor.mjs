class audioProcessor extends AudioWorkletProcessor {
    constructor(...args) {
        ...
        this.port.start();
        this.updateWavePotFunction(`function wavePot(t) { return t % 256; }`); // Default WavePot function
    }
    ...
    updateWavePotFunction(codeText) {
        ...
        try {
            ...
            this.sendData({
                error: {
                    message: audioProcessor.getErrorMessage(err, null),
                    isCompiled: false
                }
            });
        }
