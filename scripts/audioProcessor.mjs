class audioProcessor extends AudioWorkletProcessor {
	...
	setFunction(codeText) {
		const gfjs = {
			...
			"supersaw": function (x) { ((x/1.03)&255)/8+((x*1.01/1.03)&255)/8+((x*1.02/1.03)&255)/8+((x*1.03/1.03)&255)/8+((x*1.04/1.03)&255)/8+((x*1.05/1.03)&255)/8+((x*1.06/1.03)&255)/8+((x*1.07/1.03)&255)/8 }
		}
