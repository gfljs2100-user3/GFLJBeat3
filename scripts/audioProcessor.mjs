class audioProcessor extends AudioWorkletProcessor {
	...
	setFunction(codeText) {
		const gfjs = {
			...
			/*corrupt sound*/"crpt": function(x,y=8) { return gfjs.br(gfjs.br(x,y)+t,y)^chyx.br(t,y)},
			/*decorrupt sound*/"decrpt": function(x,y=8) { return gfjs.br(gfjs.br(x^chyx.br(t,y),y)-t,y)}
		}
