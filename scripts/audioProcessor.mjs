class audioProcessor extends AudioWorkletProcessor {
	...
	setFunction(codeText) {
		const gfjs = {
			...
			"supersaw": function (t) {return ((x)&255/1.03)/8+((((x)&255)*1.01)/1.03)/8+((((x)&255)*1.02)/1.03)/8+((((x)&255)*1.03)/1.03)/8+((((x)&255)*1.04)/1.03)/8+((((x)&255)*1.05)/1.03)/8+((((x)&255)*1.06)/1.03)/8+((((x)&255)*1.07)/1.03)/8 }
		}
