...
generateLibraryEntry({
	...
	async onclickCodeLoadButton(buttonElem) {
		const response = await fetch(`library/${
			buttonElem.classList.contains('json-load-formatted') ? 'formatted' :
			buttonElem.classList.contains('json-load-minified') ? 'minified' :
			buttonElem.classList.contains('json-load-original') ? 'original' : ''
